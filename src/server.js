...
const { initSocket } = require('./infrastructure/external-services/services/socket');
const { sequelize } = require('./infrastructure/database/models');
const runSeed = require('./infrastructure/database/seed/seed');
const { startReminderJob } = require('./infrastructure/external-services/jobs/reminder.job');
