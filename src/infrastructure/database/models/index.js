...
const defineRoom = require('./room.model');
const defineEvent = require('./event.model');
const defineEventDepartment = require('./event_department.model');
const defineParticipant = require('./participant.model');
const defineNotification = require('./notification.model');
const defineTask = require('./task.model');
const defineTaskAssignment = require('./task_assignment.model');
const defineProject = require('./project.model');
const defineLabel = require('./label.model');
const defineTaskLabel = require('./task_label.model');
